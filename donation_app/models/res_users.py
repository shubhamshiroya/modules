...
class ResUsers(models.Model):
    ...
    def notify_warning(self, message="New Booking Create You Can Check It", title=None, sticky=False):
        title = title or _("Information")
        self._notify_channel(WARNING, message, title, sticky)

    def notify_info(self, message="Your Upcoming Event Start in 10 Minutes Please Make Available itself", title=None, sticky=False):
        title = title or _("Information")
